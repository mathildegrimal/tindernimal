...
class CreateAnimalDto {
    static _OPENAPI_METADATA_FACTORY() {
        return { name: { required: true, type: () => String }, age: { required: true, type: () => Number }, breed: { required: true, type: () => String }, loof: { required: true, type: () => Boolean }, owner: { required: true, type: () => String } };
    }
}
__decorate([
...
], CreateAnimalDto.prototype, "loof", void 0);
__decorate([
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
], CreateAnimalDto.prototype, "owner", void 0);
